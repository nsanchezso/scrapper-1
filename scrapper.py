...
class SpeechScraper:
	...
	def __init__(self):
		self.url = "https://www.pkparaiso.com/pokemon/lista-pokemon.php"
		self.data = []


	def __download_html(self, url):
		http = urllib3.PoolManager()
		response = http.request('GET', 'https://www.pkparaiso.com/pokemon/lista-pokemon.php')
		return response

	def prueba(self):
		response = self.__download_html(self.url)
